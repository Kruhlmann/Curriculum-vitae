...
\begin{tabular}{r|p{13cm}}
	...
	\multicolumn{2}{c}{}                                                             \\
	\textsc{Mar 2012 - Aug 2013} & Full-stack developer @ Copenhagen Judo            \\ \footnotesize{1 year}&\footnotesize{Designed and developed an enrollment website using PHP, HTML, CSS, JQuery and a MySQL database.}\\
\end{tabular}
...
\begin{tabular}{lllllllll}
	TDD & Pair-programming & Refactoring & OOP & SOLID & MQTT & Agile & Scrum & Waterfall \\
\end{tabular}

\section{Technologies}
\begin{tabular}{rl}
	\textbf{Very experienced} & Rust, Python, TypeScript, SQL, Linux, Docker, CI/CD, Git, POSIX shell, REST \\
	\textbf{Experienced}      & PHP, Java, C\#, Ruby, Virtualization, WS, RabbitMQ, Redis, NixOS, Grafana,  \\
	\textbf{Learning}         & Lua, C, OCaml, WebAssembly, Azure
\end{tabular}
