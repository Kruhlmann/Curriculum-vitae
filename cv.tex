...
\begin{tabular}{r|p{11cm}}
    \multicolumn{2}{c}{} \\
    \textsc{March 2023 - Current} & Software Engineer @ Siemens Mobility A/S \\ &\footnotesize{Worked on software for railway projects such as the new CBTC system for Sporveien in Oslo and the Greater Copenhagen Light Rail}\\
...
\begin{tabular}{rl}
    ...
    & RabbitMQ, REST, POSIX shell, PHP, REST \\
